<?php 
    ...
    //             $idpais = ($pais['idpais'] == 0) ? 283 : $pais['idpais'];
    ...
    //         $idpais         = ($categoria_pais['id_site'] == 0) ? 283 : $categoria_pais['id_site'];
    ...
    // CRUCEROS *******************************************************************************************************************************************************************************
        ...
        $ejectuta =ejecuta_select($db_postgresql, $secuencia);
    ...
    //         $idstatus                                   = ($plan['activo'] == 0) ? 2 : $plan['activo'];
    ...
    //         $idpais = ($plan['id_site'] == 0) ? 283 : $plan['id_site'];
    ...
    //         $idpais  = ($plan_pais['idpais'] == 0) ? 283 : $plan_pais['idpais'];
    ...
    //         {
    //             $idpais     = ($origen['idpais'] == 0) ? 283 : $origen['idpais'];
    ...
    //         {
    //             $idpais     = ($destino['idpais'] == 0) ? 283 : $destino['idpais'];
    ...
    //         $idtipousuario              = ($escorporativo == 1) ? 4 : $usuario['idtipousuario'];
    ...
    // ORDENES *******************************************************************************************************************************************************************************
        echo 'Migrando Tabla: ordenes' . PHP_EOL;
        ...
        $select = "SELECT  
                        ...
                        CASE
                            ...
                            ELSE 'AME'
                        END as moneda_,
                        ifnull((SELECT DISTINCT valor FROM exchange where DATE_FORMAT(exchange.horainsert, '%Y-%m-%d')= orders.fecha and DATE_FORMAT(exchange.horabanco, '%Y-%m-%d')= orders.fecha and exchange.currency = moneda_ and exchange.tipo = 1 order by 1 desc LIMIT 1 ),'') as cambio
                    FROM orders 
                    WHERE orders.fecha >= '2024-01-01' 
                    AND orders.fecha <= '2024-12-31'
                    ORDER BY id ASC 
                ";

        $mysql_ = $db_mysql->query($select);

       // print_r($mysql_->fetch_array(MYSQLI_ASSOC)); exit;
